...
Vc=135*10^(-6);             % UNKNOWN PARAMETER - Defined here and then not used 
Va=135*10^(-6);             % UNKNOWN PARAMETER - Used multiple times
...
Eka=-155;                   % UNKNOWN PARAMETER - Is created here and then not used for some reason!?
